...
class Pointagram
{
    ...
    /**
     * authenticate - log in to the pointagram api
     *
    ...
    /**
     * createPlayer - retrieve details of a given commit id
     *
     * @param string $key commit id
     *
     * @return array
     */
    public function createPlayer($key)
    {
        if ($this->isAuthenticated()) {
     ...
     */
    public function list_players($key)
    {
        if ($this->isAuthenticated()) {
    ...
    /**
     * remove_player - retrieve list of pointagram branches by jira key
     *
     * @param string $key jira key
     *
     * @return array (containing branch names)
     */
    public function remove_player($key)
    {
        if ($this->isAuthenticated()) {
     ...
     * @return array
     */
    public function list_teams($key, $comment)
    {
    ...
    /**
     * remove_from_team - merge a pull request - to be used for automated launches
     *
     * @param string $key PR id
     *
     * @return array
     */
    public function remove_from_team($key)
    {
    ...
    /**
     * add_score - decline a pull request
     *
     * @param string $key PR id
     *
     * @return array
     */
    public function add_score($key)
    {
    ...
    */
    ...
    public function list_competitions($branch, $pipeline)
    {
